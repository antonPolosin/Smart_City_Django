...
INSERT INTO `django_content_type` VALUES (3,'admin','logentry'),(5,'auth','group'),(4,'auth','permission'),(6,'auth','user'),(7,'contenttypes','contenttype'),(8,'sessions','session'),(10,'sites','category'),(11,'sites','members'),(2,'sites','park'),(1,'sites','restaurant'),(9,'sites','result');
...
INSERT INTO `result` VALUES (1,'University of Queensland',NULL,'St Lucia','Brisbane',4072,'QLD','07 33651111','uqUniversity@uq.edu.au','University ',NULL,1,'College'),(2,'Queensland University of Technology',2,'George street ','Brisbane',4000,'QLD','07 31382000','qutUniversity@qut.edu.au','University ',NULL,1,'College'),(3,'Griffith University ',226,'Grey st','Brisbane',4101,'QLD','07 37377111','griffithUniversity@grif.edu.au','University ',NULL,1,'College'),(4,'Australian Catholic University',40,'Edward St','Sydney',2060,'NSW','02 97392368 ','acuUnivesrity@acu.edu.au','University ',NULL,1,'College'),(5,'Macquarie University ',3,'Technology Pl','Sydney',2109,'NSW','0 2 41222706','macUniversity@mac.edu.au','University ',NULL,1,'College'),(6,'University of New South Wales ',2,'High St','Sydney',2052,'NSW','0 2 92892177','unsw@unsw.edu.au','University ',NULL,1,'College'),(7,'University of Melbourne ',103,'Tin Alley','Melbourne ',3082,'VIC','0 3 47789460','uniMel@uniMel.edu.au','University ',NULL,1,'College'),(8,'Monash University ',40,'Exhibition walk','Melbourne ',3800,'VIC','0 3 77836293','monash@monuni.edu.au','University ',NULL,1,'College'),(9,'RMIT University ',124,'Trobe St','Melbourne ',3000,'VIC','0 3 70789217','rmit@rmit.edu.au','University ',NULL,1,'College'),(10,'University of Adelaide ',132,'Grenfell St','Adelaide ',5000,'SA','0 8 40183084','universitAdelaide@uniAde.edu.au','University ',NULL,1,'College'),(11,'Univerity of South Australia ',101,'Currie St','Adelaide ',5001,'SA','0 8 57865769','uniSA@uniSA.edu.au','University ',NULL,1,'College'),(12,'Flinders University ',NULL,'Registry Rd ','Adelaide ',5042,'SA','0 8 96942971','flinUni@flinUni.edu.au','University ',NULL,1,'College'),(13,'Australian National University ',15,'Concessions Lan','Canberra ',2601,'ACT','0 8 96942971','anu@anu.edu.au','University ',NULL,1,'College'),(14,'University of Canberra ',1,'Kirinari St','Canberra ',2617,'ACT','0 2 25116479','uniCan@uniCan.edu.au','University ',NULL,1,'College'),(15,'Australian Defence Force Academy ',33,'Academy cl','Canberra ',2612,'ACT','0 2 27705824','ADFA@ADFA.edu.au','Academy',NULL,1,'College'),(16,'tasTafe',10,'Wellignton St','Hobart ',7250,'TAS','0 3 42740596','tasTafe@tafe.edu.au','Tafe',NULL,1,'College'),(17,'University of Tasmania ',1,'Churchill Ave','Hobart ',7005,'TAS','0 3 60406632','UniTas@uniTas.edu.au','University ',NULL,1,'College'),(18,'Chales Darwin University ',1,'Casuarina ','Darwin ',810,'NT','0 8 84321862','chdarUni@cdu.edu.au','University ',NULL,1,'College'),(19,'Nungalinya College',72,'Dripstone ','Darwin ',811,'NT','0 8 50555533','nunCo@nun.edu.au','College',NULL,1,'College'),(20,'University of Western Australia ',33,'Stirling hwy','Perth',6009,'WA','0 8 10433831','UWA@UNW.edu.au','University ',NULL,1,'College'),(21,'Curtin University ',1,'Kent St','Perth',6102,'WA','0 8 63727092','CutinUni@curt.edu.au','University ',NULL,1,'College'),(22,'Edith Cowan University ',2,'Bradford St','Perth',6050,'WA','0 8 73663630','EdithCU@ecu.edu.au','University ',NULL,1,'College');
...
CREATE TABLE `review` (
  ...
  CONSTRAINT `review_ibfk_2` FOREIGN KEY (`userID`) REFERENCES `members` (`userID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-09-13 16:33:46
